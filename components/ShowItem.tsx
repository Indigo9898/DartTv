...
const ShowItem = (props:ShowItemProps) => {
    return(
        ...
        className="h-100 w-100 ">
            <div 
            className="opacity-100 h-100 w-100 white rounded-xl neonBox border-white border-2 cursor-pointer text-white pr-2 pl-2 flex flex-col justify-center items-center pt-2rem pb-2rem"
